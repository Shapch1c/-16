...
EMAIL_HOST_USER = 'Shapch1c'  # ваше имя пользователя, например, если ваша почта user@yandex.ru, то сюда надо писать user, иными словами, это всё то что идёт до собаки
...
CELERY_BROKER_URL = 'redis://:VbdV4EoDujyFbVMfzRCc2UHT5Oi9SIn2@redis-11279.c238.us-central1-2.gce.redns.redis-cloud.com:11279'
CELERY_RESULT_BACKEND = 'redis://:VbdV4EoDujyFbVMfzRCc2UHT5Oi9SIn2@redis-11279.c238.us-central1-2.gce.redns.redis-cloud.com:11279'
